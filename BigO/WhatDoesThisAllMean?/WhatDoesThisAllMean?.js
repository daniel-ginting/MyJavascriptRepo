...
You may have noticed something while talking about Big O. Scalable means we worry only about large inputs. What does the end of the graph look like? If our function is only worry about really small inputs or we know that our inputs are only going to be, let's say an array of five items, Big O won't matter as much does it? But is it real life? NO. Because as humans we tend to think in here and now. We tend to think that, oh` our website is only going to have a hundred users, that's it. But what if that user base grows? What if our inputs grow? We never know.
